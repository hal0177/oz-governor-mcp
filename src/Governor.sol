...
abstract contract Governor is Context, ERC165, EIP712, Nonces, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function _governanceCallPushBack(bytes32 calldatas) internal {
        _governanceCall.pushBack(calldatas);
    }

    function _governanceCallClear() internal {
        _governanceCall.clear();
    }

    function _setProposalEtaSeconds(uint256 proposalId, uint48 etaSeconds) internal {
        _proposals[proposalId].etaSeconds = etaSeconds;
    }

    function _governanceCallEmpty() internal view returns (bool) {
